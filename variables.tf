...
variable "alb_protocols" {
  description = "The protocols the LB accepts. e.g.: [\"HTTPS\"]"
  type        = "list"
  default     = ["HTTPS"]
}
...
variable "alb_is_type_network" {
  description = "Boolean determining if the LB is a network load balancer."
  default     = false
}
...
variable "log_bucket_name" {
  description = "S3 bucket for storing LB access logs. Setting this means the module will try to create the bucket."
  default     = ""
}
